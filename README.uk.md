...
2. **Налаштуйте шляхи**:
   ...
   - Встановіть **Шлях до модів** (звідки 3DMigoto завантажує моди)
   - Встановіть **Шлях до збережених модів** (де зберігається ваша колекція модів)

3. **Імпортуйте моди**:
   - Використайте Drag & Drop для додавання папок з модами
...
4. **Активуйте моди**:
   ...
   - Натисніть F10 у грі (або використайте функцію автоматичного перезавантаження)

### Розуміння шляхів

- **Шлях до модів**: Директорія, звідки 3DMigoto завантажує активні моди
  - Приклад: `/шлях/до/3DMigoto/Mods`
  - Тут створюються символічні посилання на активні моди

- **Шлях до збережених модів**: Місце зберігання вашої бібліотеки модів
  - Приклад: `/шлях/до/3DMigoto/SaveMods`
  - Тут зберігаються оригінальні папки модів
